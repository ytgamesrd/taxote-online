...
function openMenu(){ $("#side-menu").classList.add("open"); $("#drawer-overlay").hidden=false; }
function closeMenu(){ $("#side-menu").classList.remove("open"); $("#drawer-overlay").hidden=true; }
